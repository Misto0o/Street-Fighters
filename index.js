...
const shop = new Sprite({
  ...
  imageSrc: 'https://raw.githubusercontent.com/chriscourses/fighting-game/main/img/shop.png',
  scale: 2.75,
  framesMax: 6
})
...
const player = new Fighter({
  ...
  sprites: {
    ...
    takeHit: {
      imageSrc: 'https://raw.githubusercontent.com/chriscourses/fighting-game/main/img/samuraiMack/Take%20Hit.png',
      framesMax: 4
    },
    death: {
...
const enemy = new Fighter({
  ...
  sprites: {
    ...
    takeHit: {
      imageSrc: 'https://raw.githubusercontent.com/chriscourses/fighting-game/main/img/kenji/Take%20hit.png',
      framesMax: 3
    },
    death: {
